...
/// <summary>Mirrors <c>UMS.Modules.Identity.IntegrationTests.Infrastructure.TestUsers</c> exactly - Organization's own suite needs a real, logged-in Identity User to call its permission-gated endpoints.</summary>
