...
/// <summary>Hostel's own outbox (ADR-0014) - drained by <c>UMS.Workers</c>' Hostel Notifications relay through this module's own <c>IOutboxReader</c>. Mirrors every other module's own configuration exactly.</summary>
