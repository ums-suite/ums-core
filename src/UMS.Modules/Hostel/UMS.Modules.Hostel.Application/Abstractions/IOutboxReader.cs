...
/// <summary>The read/ack side of Hostel's own outbox (ADR-0014) - mirrors every other module's own <c>IOutboxReader</c>. Drives the Notifications fan-out relay worker.</summary>
