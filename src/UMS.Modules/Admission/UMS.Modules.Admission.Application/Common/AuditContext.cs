...
{
    private const string CallingApplication = "ums-admission-internal";
    ...
    /// <summary>A system/background-job actor (the payment-confirmation relay, the timeout sweep, the publish job worker) - no client IP.</summary>
