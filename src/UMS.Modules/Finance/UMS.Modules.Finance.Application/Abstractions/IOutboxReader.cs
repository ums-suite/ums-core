...
/// <summary>The read/ack side of Finance's own outbox (ADR-0014), consumed by <c>UMS.Workers</c>' relays - mirrors every other module's own <c>IOutboxReader</c>.</summary>
