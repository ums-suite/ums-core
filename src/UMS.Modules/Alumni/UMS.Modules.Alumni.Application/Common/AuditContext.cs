...
/// <summary>requirement-spec.md §5 Auditability / §7 Audit (ADR-0012, ALM-16): mirrors every other module's own <c>AuditContext</c> exactly (per-module duplication is the established convention).</summary>
public sealed record AuditContext(Guid ActorUserId, string? ActorIpAddress, string CorrelationId)
{
    private const string CallingApplication = "ums-alumni-internal";
