...
public static class TransactionalAuditWriter
{
    ...
    /// <summary>A commit with NO audit write - reserved for scheduled-sweep no-op ticks (nothing lapsed this pass). Every REAL mutation still goes through <see cref="CommitWithAuditAsync"/>.</summary>
