...
/// <summary>Content's own outbox (ADR-0014) - drained by <c>UMS.Workers</c>'s Notice notification relay (CNT-13) through this module's own <c>IOutboxReader</c>. Mirrors every other module's own configuration exactly.</summary>
