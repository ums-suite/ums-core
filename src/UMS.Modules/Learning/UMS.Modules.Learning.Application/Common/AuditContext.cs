...
/// <summary>Bundles the caller-identity fields every mutation call site needs to pass to <see cref="IAuditRecorder"/> - mirrors Academic/Faculty/Student's own <c>AuditContext</c> exactly.</summary>
public sealed record AuditContext(Guid ActorUserId, string? ActorIpAddress, string CorrelationId)
{
    private const string CallingApplication = "ums-learning-web";
