...
/// <summary>The read/ack side of Learning's own outbox (ADR-0014), consumed by <c>UMS.Workers</c>' relays - mirrors Faculty's/Documents'/Audit's own <c>IOutboxReader</c>.</summary>
