...
/// <summary>Thrown by the DbContext when an `xmin`-guarded ordinary write loses an optimistic-concurrency race. Mirrors Academic/Faculty/Student's own copy exactly.</summary>
