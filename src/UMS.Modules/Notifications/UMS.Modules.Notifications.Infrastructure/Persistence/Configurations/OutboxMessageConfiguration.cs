...
/// <summary>Notifications' own <c>notifications.outbox_messages</c> table (ADR-0014) - same shared row shape as Identity's/Audit's own outbox tables.</summary>
internal sealed class OutboxMessageConfiguration : IEntityTypeConfiguration<OutboxMessage>
{
    public void Configure(EntityTypeBuilder<OutboxMessage> builder)
    {
        ...
        builder.HasIndex(m => m.ProcessedAt).HasDatabaseName("ix_notifications_outbox_messages_processed_at");
    }
}
