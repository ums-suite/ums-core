...
/// Student's own mutation call sites: record-then-save-then-commit, both-or-neither via one shared
/// transaction. Mirrors Faculty's own <c>TransactionalAuditWriter</c> exactly.
/// </summary>
