...
/// <summary>Research's own outbox (ADR-0014) - drained by <c>UMS.Workers</c>'s notification relay (RES-15). Mirrors every other module's own configuration exactly.</summary>
