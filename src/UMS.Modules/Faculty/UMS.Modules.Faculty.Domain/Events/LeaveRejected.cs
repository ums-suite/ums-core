...
public sealed record LeaveRejected(Guid LeaveRequestId, Guid FacultyMemberId, Guid RequesterUserId, Guid ApproverUserId, string? Reason, DateTimeOffset OccurredAt) : IDomainEvent;
