...
/// <summary>Library's own outbox (ADR-0014) - drained by <c>UMS.Workers</c>' Library relays through this module's own <c>IOutboxReader</c>. Mirrors every other module's own configuration exactly.</summary>
