...
/// <summary>The read/ack side of Library's own outbox (ADR-0014) - mirrors every other module's own <c>IOutboxReader</c>. Drives the Notifications fan-out relay AND LIB-9's own reservation-fulfillment relay (event-driven off <c>LoanReturned</c>).</summary>
